...
class Script
{
	...
	public static function createStenSprite(image:String, locX:Int, locY:Int, visible:Bool)
		{
			var StenSprite:FlxSprite = new FlxSprite(Std.parseInt(locX), Std.parseInt(locY)).loadGraphic(Paths.loadImage(image));
            if(visible == true)
                {
                    StenSprite.visible = true;
                }
            if(visible == false)
                {
                    StenSprite.visible = false;
                }
            if(visible == null)
                 {
                    StenSprite.visible = true;
                        ...
                        if(spriteCount == 0)
                            {
                                ...
                                createStenSprite(imagse, xsprite,ysprite, true);
                            }
