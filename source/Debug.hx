...
class Debug
{
	static final LOG_STYLE_ERROR:LogStyle = new LogStyle('[STEN ERROR] ', 'FF8888', 12, true, false, false, 'flixel/sounds/beep', true);
	static final LOG_STYLE_WARN:LogStyle = new LogStyle('[STEN WARN ] ', 'D9F85C', 12, true, false, false, 'flixel/sounds/beep', true);
	static final LOG_STYLE_INFO:LogStyle = new LogStyle('[STEN INFO ] ', '5CF878', 12, false);
	static final LOG_STYLE_TRACE:LogStyle = new LogStyle('[STEN TRACE] ', '5CF878', 12, false);
	...
	public static function onInitProgram()
	{
		...
		logInfo('StenEngine version: ${MainMenuState.StenEngineVer}');
	}
	...
	public static function onGameStart()
	{
		...
		if (FlxG.save.data.debugLogLevel == null)
			FlxG.save.data.debugLogLevel = "STEN TRACE";
	...
	static function writeToLogFile(data:Array<Dynamic>, logLevel:String = "STEN TRACE")
	{
...
class DebugLogWriter
{
	...
	public static final LOG_LEVELS = ['STEN ERROR', 'STEN WARN', 'STEN INFO', 'STEN TRACE'];
	...
	public function new(logLevelParam:String)
	{
		...
		if (logFilePath.indexOf("/") != -1)
		{
			...
			printDebug('Sten Engine Started! Welcome');
			printDebug('----------------------------');
			printDebug('Sten Engine Credits');
			printDebug('- EmreFnF (Sten Engine Owner)');
			printDebug('- Behlul  (Sten Engine A few ideas)');
			printDebug('----------------------------');
			printDebug('Versions :');
			printDebug('HaxeFlixel version: ${Std.string(FlxG.VERSION)}');
		    printDebug('Friday Night Funkin\' version: ${MainMenuState.gameVer}');
		    printDebug('Sten Engine version: ${MainMenuState.StenEngineVer}');
	 ...
	 */
	public function write(input:Array<Dynamic>, logLevel = 'STEN TRACE'):Void
	{
