...
class Replay
{
	...
	public function SaveReplay(notearray:Array<Dynamic>, judge:Array<String>, ana:Analysis)
	{
		...
		#if FEATURE_FILESYSTEM
		File.saveContent("assets/replays/replay-" + PlayState.SONG.songId + "-time" + time + ".StenReplay", data);

		path = "replay-" + PlayState.SONG.songId + "-time" + time + ".StenReplay"; // for score screen shit
