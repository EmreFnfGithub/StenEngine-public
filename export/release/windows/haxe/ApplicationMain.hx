...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("StenEngine", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("StenEngine", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "1562";
		app.meta["company"] = "EmreFnF";
		app.meta["file"] = "StenEngine";
		app.meta["name"] = "Friday Night Funkin': Sten Engine";
		app.meta["packageName"] = "com.emrefnf.stenengine";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: true,
			title: "Friday Night Funkin': Sten Engine",
			width: 1280,
			x: null,
			y: null,
		};
