...
HX_DECLARE_STACK_FRAME(_hx_pos_1b9a64f7c24482df_67_new)
...
HXLINE(  68)		( ( ::WeekData)(__this) )->songs = ( (::cpp::VirtualArray)(weekFile->__Field(HX_("songs",fe,36,c7,80),::hx::paccDynamic)) );
HXLINE(  69)		( ( ::WeekData)(__this) )->weekCharacters = ( (::Array< ::String >)(weekFile->__Field(HX_("weekCharacters",be,b5,7f,1d),::hx::paccDynamic)) );
...
HXLINE(  75)		( ( ::WeekData)(__this) )->hiddenUntilUnlocked = ( (bool)(weekFile->__Field(HX_("hiddenUntilUnlocked",17,ed,31,dc),::hx::paccDynamic)) );
HXLINE(  76)		( ( ::WeekData)(__this) )->hideStoryMode = ( (bool)(weekFile->__Field(HX_("hideStoryMode",d6,b4,4e,4c),::hx::paccDynamic)) );
HXLINE(  77)		( ( ::WeekData)(__this) )->hideFreeplay = ( (bool)(weekFile->__Field(HX_("hideFreeplay",82,13,8c,e3),::hx::paccDynamic)) );
HXLINE(  78)		( ( ::WeekData)(__this) )->difficulties = ( (::String)(weekFile->__Field(HX_("difficulties",59,c7,5e,02),::hx::paccDynamic)) );
HXLINE(  80)		( ( ::WeekData)(__this) )->fileName = fileName;
            	}
