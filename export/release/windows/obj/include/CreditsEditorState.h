...
#define INCLUDED_CreditsEditorState
...
HX_DECLARE_CLASS0(CreditsEditorState)
...
class HXCPP_CLASS_ATTRIBUTES CreditsEditorState_obj : public  ::MusicBeatState_obj
{
	public:
	...
	public:
		enum { _hx_ClassId = 0x3ab7e40a };

		void __construct( ::flixel::addons::transition::TransitionData TransIn, ::flixel::addons::transition::TransitionData TransOut);
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="CreditsEditorState")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"CreditsEditorState"); }
...
#endif /* INCLUDED_CreditsEditorState */ 
