...
HX_DECLARE_STACK_FRAME(_hx_pos_2fe4ccbf892e1eb4_326_new)
...
HXLINE( 329)		( ( ::CreditsMetadata)(__this) )->desc = HX_("",00,00,00,00);
HXLINE( 328)		( ( ::CreditsMetadata)(__this) )->modderName = HX_("",00,00,00,00);
HXLINE( 333)		( ( ::CreditsMetadata)(__this) )->modderName = name;
HXLINE( 334)		( ( ::CreditsMetadata)(__this) )->desc = desc;
            	}
