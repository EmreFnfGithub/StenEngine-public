...
class HXCPP_CLASS_ATTRIBUTES EditorsMain_obj : public  ::flixel::FlxSubState_obj
{
	public:
	...
	public:
		...
		static ::hx::ObjectPtr< EditorsMain_obj > __new( ::Dynamic BGColor);
		static ::hx::ObjectPtr< EditorsMain_obj > __alloc(::hx::Ctx *_hx_ctx, ::Dynamic BGColor);
