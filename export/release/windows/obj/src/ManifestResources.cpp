...
HXLINE(  54)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__assets_fonts_muffnew_ttf >());
...
HXLINE(  78)		{
HXLINE(  78)			::String v3 = (::ManifestResources_obj::rootPath + HX_("manifest/week1.json",19,f4,32,f2));
HXDLIN(  78)			::lime::utils::Assets_obj::libraryPaths->set(HX_("week1",bd,95,be,c7),v3);
            		}
HXLINE(  79)		{
HXLINE(  79)			::String v4 = (::ManifestResources_obj::rootPath + HX_("manifest/week2.json",78,50,8e,58));
HXDLIN(  79)			::lime::utils::Assets_obj::libraryPaths->set(HX_("week2",be,95,be,c7),v4);
            		}
HXLINE(  80)		{
HXLINE(  80)			::String v5 = (::ManifestResources_obj::rootPath + HX_("manifest/week3.json",d7,ac,e9,be));
HXDLIN(  80)			::lime::utils::Assets_obj::libraryPaths->set(HX_("week3",bf,95,be,c7),v5);
            		}
HXLINE(  81)		{
HXLINE(  81)			::String v6 = (::ManifestResources_obj::rootPath + HX_("manifest/week4.json",36,09,45,25));
HXDLIN(  81)			::lime::utils::Assets_obj::libraryPaths->set(HX_("week4",c0,95,be,c7),v6);
            		}
HXLINE(  82)		{
HXLINE(  82)			::String v7 = (::ManifestResources_obj::rootPath + HX_("manifest/week5.json",95,65,a0,8b));
HXDLIN(  82)			::lime::utils::Assets_obj::libraryPaths->set(HX_("week5",c1,95,be,c7),v7);
            		}
HXLINE(  83)		{
HXLINE(  83)			::String v8 = (::ManifestResources_obj::rootPath + HX_("manifest/week6.json",f4,c1,fb,f1));
HXDLIN(  83)			::lime::utils::Assets_obj::libraryPaths->set(HX_("week6",c2,95,be,c7),v8);
            		}
HXLINE(  84)		{
HXLINE(  84)			::String v9 = (::ManifestResources_obj::rootPath + HX_("manifest/sm.json",dc,54,48,0c));
HXDLIN(  84)			::lime::utils::Assets_obj::libraryPaths->set(HX_("sm",9a,64,00,00),v9);
            		}
HXLINE(  85)		{
HXLINE(  85)			::String v10 = (::ManifestResources_obj::rootPath + HX_("manifest/default.json",95,ea,cc,42));
HXDLIN(  85)			::lime::utils::Assets_obj::libraryPaths->set(HX_("default",c1,d8,c3,9b),v10);
            		}
...
HXLINE(  94)		library = ::lime::utils::Assets_obj::getLibrary(HX_("tutorial",9e,8f,b5,82));
HXLINE(  95)		if (::hx::IsNotNull( library )) {
HXLINE(  95)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE(  96)			::ManifestResources_obj::preloadLibraryNames->push(HX_("tutorial",9e,8f,b5,82));
            		}
HXLINE(  97)		library = ::lime::utils::Assets_obj::getLibrary(HX_("week1",bd,95,be,c7));
HXLINE(  98)		if (::hx::IsNotNull( library )) {
HXLINE(  98)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE(  99)			::ManifestResources_obj::preloadLibraryNames->push(HX_("week1",bd,95,be,c7));
            		}
HXLINE( 100)		library = ::lime::utils::Assets_obj::getLibrary(HX_("week2",be,95,be,c7));
HXLINE( 101)		if (::hx::IsNotNull( library )) {
HXLINE( 101)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 102)			::ManifestResources_obj::preloadLibraryNames->push(HX_("week2",be,95,be,c7));
            		}
HXLINE( 103)		library = ::lime::utils::Assets_obj::getLibrary(HX_("week3",bf,95,be,c7));
HXLINE( 104)		if (::hx::IsNotNull( library )) {
HXLINE( 104)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 105)			::ManifestResources_obj::preloadLibraryNames->push(HX_("week3",bf,95,be,c7));
            		}
HXLINE( 106)		library = ::lime::utils::Assets_obj::getLibrary(HX_("week4",c0,95,be,c7));
HXLINE( 107)		if (::hx::IsNotNull( library )) {
HXLINE( 107)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 108)			::ManifestResources_obj::preloadLibraryNames->push(HX_("week4",c0,95,be,c7));
            		}
HXLINE( 109)		library = ::lime::utils::Assets_obj::getLibrary(HX_("week5",c1,95,be,c7));
HXLINE( 110)		if (::hx::IsNotNull( library )) {
HXLINE( 110)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 111)			::ManifestResources_obj::preloadLibraryNames->push(HX_("week5",c1,95,be,c7));
            		}
HXLINE( 112)		library = ::lime::utils::Assets_obj::getLibrary(HX_("week6",c2,95,be,c7));
HXLINE( 113)		if (::hx::IsNotNull( library )) {
HXLINE( 113)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 114)			::ManifestResources_obj::preloadLibraryNames->push(HX_("week6",c2,95,be,c7));
            		}
HXLINE( 115)		library = ::lime::utils::Assets_obj::getLibrary(HX_("sm",9a,64,00,00));
HXLINE( 116)		if (::hx::IsNotNull( library )) {
HXLINE( 116)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 117)			::ManifestResources_obj::preloadLibraryNames->push(HX_("sm",9a,64,00,00));
            		}
