...
HX_DEFINE_STACK_FRAME(_hx_pos_6792520ec1fdc52f_727_new,"FreeplaySongMetadata","new",0x8af37036,"FreeplaySongMetadata.new","FreeplayState.hx",727,0x0d86f62d)
...
void FreeplaySongMetadata_obj::__construct(::String song,int week,::String songCharacter, ::smTools::SMFile sm,::String __o_path){
            	...
            	HX_STACKFRAME(&_hx_pos_6792520ec1fdc52f_727_new)
HXLINE( 737)		this->diffs = ::Array_obj< ::String >::__new(0);
HXLINE( 735)		this->songCharacter = HX_("",00,00,00,00);
HXLINE( 730)		this->week = 0;
HXLINE( 729)		this->songName = HX_("",00,00,00,00);
HXLINE( 742)		this->songName = song;
HXLINE( 743)		this->week = week;
HXLINE( 744)		this->songCharacter = songCharacter;
HXLINE( 745)		this->sm = sm;
HXLINE( 746)		this->path = path;
            	}
