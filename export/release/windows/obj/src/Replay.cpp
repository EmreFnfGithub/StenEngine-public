...
HXLINE( 123)		::sys::io::File_obj::saveContent(( (::String)(((((HX_("assets/replays/replay-",77,41,6e,f6) + ::PlayState_obj::SONG->__Field(HX_("songId",10,c3,88,2d),::hx::paccDynamic)) + HX_("-time",ba,e6,04,36)) + time) + HX_(".StenReplay",df,1f,b6,bf))) ),data);
HXLINE( 125)		this->path = ( (::String)(((((HX_("replay-",26,5b,28,ab) + ::PlayState_obj::SONG->__Field(HX_("songId",10,c3,88,2d),::hx::paccDynamic)) + HX_("-time",ba,e6,04,36)) + time) + HX_(".StenReplay",df,1f,b6,bf))) );
