...
HXLINE( 203)		{
HXLINE( 203)			 ::Dynamic input4 = (HX_("StenEngine version: ",6a,3d,66,d2) + ::MainMenuState_obj::StenEngineVer);
...
HXLINE( 219)			::flixel::FlxG_obj::save->data->__SetField(HX_("debugLogLevel",d3,6b,21,7d),HX_("STEN TRACE",0f,95,f7,04),::hx::paccDynamic);
            		}
...
HXDLIN(  24)		LOG_STYLE_ERROR =  ::flixel::_hx_system::debug::log::LogStyle_obj::__alloc( HX_CTX ,HX_("[STEN ERROR] ",d0,78,45,0f),HX_("FF8888",40,7f,36,70),12,true,false,false,HX_("flixel/sounds/beep",e6,b5,a9,33),true,null());
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_c70b4b5185508337_25_boot)
HXDLIN(  25)		LOG_STYLE_WARN =  ::flixel::_hx_system::debug::log::LogStyle_obj::__alloc( HX_CTX ,HX_("[STEN WARN ] ",c2,88,e7,2e),HX_("D9F85C",15,36,8b,30),12,true,false,false,HX_("flixel/sounds/beep",e6,b5,a9,33),true,null());
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_c70b4b5185508337_26_boot)
HXDLIN(  26)		LOG_STYLE_INFO =  ::flixel::_hx_system::debug::log::LogStyle_obj::__alloc( HX_CTX ,HX_("[STEN INFO ] ",9a,fb,38,33),HX_("5CF878",41,9b,32,f3),12,false,null(),null(),null(),null(),null());
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_c70b4b5185508337_27_boot)
HXDLIN(  27)		LOG_STYLE_TRACE =  ::flixel::_hx_system::debug::log::LogStyle_obj::__alloc( HX_CTX ,HX_("[STEN TRACE] ",cd,24,3f,ad),HX_("5CF878",41,9b,32,f3),12,false,null(),null(),null(),null(),null());
            	}
{
