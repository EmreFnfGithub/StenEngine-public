...
HX_LOCAL_STACK_FRAME(_hx_pos_b4c29dfb4fdbfec8_2037_updateDisplay,"LockWeeksOption","updateDisplay",0x41787494,"LockWeeksOption.updateDisplay","Options.hx",2037,0x9d9a0240)
...
HXLINE(2027)		::flixel::FlxG_obj::save->data->__SetField(HX_("weekUnlocked",37,64,c4,a5),1,::hx::paccDynamic);
HXLINE(2028)		::StoryMenuState_obj::weekUnlocked = ::Array_obj< bool >::fromData( _hx_array_data_f0cd6c89_2,2);
HXLINE(2029)		this->confirm = false;
HXLINE(2031)		this->display = this->updateDisplay();
HXLINE(2032)		return true;
            	}


::String LockWeeksOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_b4c29dfb4fdbfec8_2037_updateDisplay)
HXDLIN(2037)		if (this->confirm) {
HXDLIN(2037)			return HX_("Confirm Story Reset",e4,1f,01,6b);
            		}
            		else {
HXDLIN(2037)			return HX_("Reset Story Progress",c9,28,76,d8);
            		}
