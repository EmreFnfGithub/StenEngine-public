...
HX_DEFINE_STACK_FRAME(_hx_pos_834c19109e22570a_1876_new,"LuaGame","new",0x8b439b9c,"LuaGame.new","LuaClass.hx",1876,0xe0a4e33e)
HX_DEFINE_STACK_FRAME(_hx_pos_834c19109e22570a_1881_new,"LuaGame","new",0x8b439b9c,"LuaGame.new","LuaClass.hx",1881,0xe0a4e33e)
HX_DEFINE_STACK_FRAME(_hx_pos_834c19109e22570a_1890_new,"LuaGame","new",0x8b439b9c,"LuaGame.new","LuaClass.hx",1890,0xe0a4e33e)
HX_DEFINE_STACK_FRAME(_hx_pos_834c19109e22570a_1899_new,"LuaGame","new",0x8b439b9c,"LuaGame.new","LuaClass.hx",1899,0xe0a4e33e)
HX_DEFINE_STACK_FRAME(_hx_pos_834c19109e22570a_1904_new,"LuaGame","new",0x8b439b9c,"LuaGame.new","LuaClass.hx",1904,0xe0a4e33e)
HX_DEFINE_STACK_FRAME(_hx_pos_834c19109e22570a_1867_new,"LuaGame","new",0x8b439b9c,"LuaGame.new","LuaClass.hx",1867,0xe0a4e33e)
HX_LOCAL_STACK_FRAME(_hx_pos_834c19109e22570a_1936_SetNumProperty,"LuaGame","SetNumProperty",0x2c9e2e9d,"LuaGame.SetNumProperty","LuaClass.hx",1936,0xe0a4e33e)
HX_LOCAL_STACK_FRAME(_hx_pos_834c19109e22570a_1951_Register,"LuaGame","Register",0x8cab5dc7,"LuaGame.Register","LuaClass.hx",1951,0xe0a4e33e)
HX_LOCAL_STACK_FRAME(_hx_pos_834c19109e22570a_1913_changeStage,"LuaGame","changeStage",0x1a987a6a,"LuaGame.changeStage","LuaClass.hx",1913,0xe0a4e33e)
HX_LOCAL_STACK_FRAME(_hx_pos_834c19109e22570a_1933_boot,"LuaGame","boot",0x47fd8d76,"LuaGame.boot","LuaClass.hx",1933,0xe0a4e33e)

void LuaGame_obj::__construct(){
            		HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_0) HXARGC(2)
            		int _hx_run( cpp::Reference<lua_State> l, ::Dynamic data){
            			HX_GC_STACKFRAME(&_hx_pos_834c19109e22570a_1876_new)
HXLINE(1877)			lua_pushnumber(l,::PlayState_obj::instance->health);
HXLINE(1878)			return 1;
            		}
            		HX_END_LOCAL_FUNC2(return)

            		HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_1) HXARGC(1)
            		int _hx_run( cpp::Reference<lua_State> l){
            			HX_GC_STACKFRAME(&_hx_pos_834c19109e22570a_1881_new)
HXLINE(1882)			::PlayState_obj::instance->health = lua_tonumber(l,3);
HXLINE(1883)			return 0;
            		}
            		HX_END_LOCAL_FUNC1(return)

            		HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_2) HXARGC(2)
            		int _hx_run( cpp::Reference<lua_State> l, ::Dynamic data){
            			HX_GC_STACKFRAME(&_hx_pos_834c19109e22570a_1890_new)
HXLINE(1891)			lua_pushnumber(l,::PlayState_obj::instance->accuracy);
HXLINE(1892)			return 1;
            		}
            		HX_END_LOCAL_FUNC2(return)

            		HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_3) HXARGC(2)
            		int _hx_run( cpp::Reference<lua_State> l, ::Dynamic data){
            			HX_GC_STACKFRAME(&_hx_pos_834c19109e22570a_1899_new)
HXLINE(1900)			linc::lua::pushcfunction(l,::LuaGame_obj::changeStageC);
HXLINE(1901)			return 1;
            		...
            		int _hx_run( cpp::Reference<lua_State> l){
            			HX_GC_STACKFRAME(&_hx_pos_834c19109e22570a_1904_new)
HXLINE(1905)			linc::lual::error(l,HX_("changeStage is read-only.",cf,79,85,d3));
HXLINE(1906)			return 0;
            		}
            		HX_END_LOCAL_FUNC1(return)

            	HX_GC_STACKFRAME(&_hx_pos_834c19109e22570a_1867_new)
HXLINE(1868)		super::__construct();
HXLINE(1869)		this->className = HX_("Game",12,20,38,2f);
HXLINE(1871)		 ::haxe::ds::StringMap _g =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXDLIN(1871)		_g->set(HX_("health",9c,28,06,fd), ::Dynamic(::hx::Anon_obj::Create(3)
...
HXDLIN(1871)		_g->set(HX_("accuracy",39,06,c5,ff), ::Dynamic(::hx::Anon_obj::Create(3)
...
HXDLIN(1871)		_g->set(HX_("changeStage",2e,13,d1,a9), ::Dynamic(::hx::Anon_obj::Create(3)
...
HXDLIN(1871)		this->properties = _g;
            	}
...
int LuaGame_obj::SetNumProperty( cpp::Reference<lua_State> l){
            	HX_STACKFRAME(&_hx_pos_834c19109e22570a_1936_SetNumProperty)
HXLINE(1941)		if ((lua_type(l,3) != 3)) {
HXLINE(1943)			linc::lual::error(l,((HX_("invalid argument #3 (number expected, got ",25,84,c0,d9) + linc::lua::_typename(l,lua_type(l,3))) + HX_(")",29,00,00,00)));
HXLINE(1944)			return 0;
            		}
HXLINE(1946)		 ::lime::ui::Window _hx_tmp = ::lime::app::Application_obj::current->_hx___window;
HXDLIN(1946)		::String _hx_tmp1 = linc::lua::tostring(l,2);
HXDLIN(1946)		::Reflect_obj::setProperty(_hx_tmp,_hx_tmp1,lua_tonumber(l,3));
HXLINE(1947)		return 0;
            	}
...
void LuaGame_obj::Register( cpp::Reference<lua_State> l){
            	HX_STACKFRAME(&_hx_pos_834c19109e22570a_1951_Register)
HXLINE(1952)		::LuaGame_obj::state = l;
HXLINE(1953)		this->super::Register(l);
            	}
...
int LuaGame_obj::changeStage( lua_State* l){
            	HX_GC_STACKFRAME(&_hx_pos_834c19109e22570a_1913_changeStage)
HXLINE(1916)		::String stageName = linc::lual::checkstring(::LuaGame_obj::state,2);
HXLINE(1918)		{
HXLINE(1918)			int _g = 0;
HXDLIN(1918)			::cpp::VirtualArray _g1 = ::PlayState_obj::Stage->toAdd;
HXDLIN(1918)			while((_g < _g1->get_length())){
HXLINE(1918)				 ::Dynamic i = _g1->__get(_g);
HXDLIN(1918)				_g = (_g + 1);
HXLINE(1920)				::PlayState_obj::instance->remove(i,null()).StaticCast<  ::flixel::FlxBasic >();
            			}
            		}
HXLINE(1923)		::PlayState_obj::Stage =  ::Stage_obj::__alloc( HX_CTX ,stageName);
HXLINE(1925)		{
HXLINE(1925)			int _g2 = 0;
HXDLIN(1925)			::cpp::VirtualArray _g3 = ::PlayState_obj::Stage->toAdd;
HXDLIN(1925)			while((_g2 < _g3->get_length())){
HXLINE(1925)				 ::Dynamic i = _g3->__get(_g2);
HXDLIN(1925)				_g2 = (_g2 + 1);
HXLINE(1927)				::PlayState_obj::instance->add(i).StaticCast<  ::flixel::FlxBasic >();
            			}
            		}
...
{
{
            	HX_STACKFRAME(&_hx_pos_834c19109e22570a_1933_boot)
HXDLIN(1933)		changeStageC = ::cpp::Function< int ( lua_State*)>(::hx::AnyCast(&::LuaGame_obj::changeStage ));
            	}
}
