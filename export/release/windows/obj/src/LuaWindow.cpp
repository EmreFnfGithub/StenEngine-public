...
HX_DEFINE_STACK_FRAME(_hx_pos_bc049608668cd482_1770_new,"LuaWindow","new",0x4b52f09a,"LuaWindow.new","LuaClass.hx",1770,0xe0a4e33e)
HX_DEFINE_STACK_FRAME(_hx_pos_bc049608668cd482_1780_new,"LuaWindow","new",0x4b52f09a,"LuaWindow.new","LuaClass.hx",1780,0xe0a4e33e)
HX_DEFINE_STACK_FRAME(_hx_pos_bc049608668cd482_1790_new,"LuaWindow","new",0x4b52f09a,"LuaWindow.new","LuaClass.hx",1790,0xe0a4e33e)
HX_DEFINE_STACK_FRAME(_hx_pos_bc049608668cd482_1800_new,"LuaWindow","new",0x4b52f09a,"LuaWindow.new","LuaClass.hx",1800,0xe0a4e33e)
HX_DEFINE_STACK_FRAME(_hx_pos_bc049608668cd482_1810_new,"LuaWindow","new",0x4b52f09a,"LuaWindow.new","LuaClass.hx",1810,0xe0a4e33e)
HX_DEFINE_STACK_FRAME(_hx_pos_bc049608668cd482_1815_new,"LuaWindow","new",0x4b52f09a,"LuaWindow.new","LuaClass.hx",1815,0xe0a4e33e)
HX_DEFINE_STACK_FRAME(_hx_pos_bc049608668cd482_1762_new,"LuaWindow","new",0x4b52f09a,"LuaWindow.new","LuaClass.hx",1762,0xe0a4e33e)
HX_LOCAL_STACK_FRAME(_hx_pos_bc049608668cd482_1841_SetNumProperty,"LuaWindow","SetNumProperty",0xe4d61e5f,"LuaWindow.SetNumProperty","LuaClass.hx",1841,0xe0a4e33e)
HX_LOCAL_STACK_FRAME(_hx_pos_bc049608668cd482_1856_Register,"LuaWindow","Register",0xbf313009,"LuaWindow.Register","LuaClass.hx",1856,0xe0a4e33e)
HX_LOCAL_STACK_FRAME(_hx_pos_bc049608668cd482_1824_tweenPos,"LuaWindow","tweenPos",0x26ac4d6f,"LuaWindow.tweenPos","LuaClass.hx",1824,0xe0a4e33e)
HX_LOCAL_STACK_FRAME(_hx_pos_bc049608668cd482_1838_boot,"LuaWindow","boot",0x955896b8,"LuaWindow.boot","LuaClass.hx",1838,0xe0a4e33e)

void LuaWindow_obj::__construct(){
            		HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_0) HXARGC(2)
            		int _hx_run( cpp::Reference<lua_State> l, ::Dynamic data){
            			HX_GC_STACKFRAME(&_hx_pos_bc049608668cd482_1770_new)
HXLINE(1771)			lua_pushnumber(l,( (Float)(::lime::app::Application_obj::current->_hx___window->_hx___x) ));
HXLINE(1772)			return 1;
            		}
            		HX_END_LOCAL_FUNC2(return)

            		HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_1) HXARGC(2)
            		int _hx_run( cpp::Reference<lua_State> l, ::Dynamic data){
            			HX_GC_STACKFRAME(&_hx_pos_bc049608668cd482_1780_new)
HXLINE(1781)			lua_pushnumber(l,( (Float)(::lime::app::Application_obj::current->_hx___window->_hx___y) ));
HXLINE(1782)			return 1;
            		...
            		int _hx_run( cpp::Reference<lua_State> l, ::Dynamic data){
            			HX_GC_STACKFRAME(&_hx_pos_bc049608668cd482_1790_new)
HXLINE(1791)			lua_pushnumber(l,( (Float)(::lime::app::Application_obj::current->_hx___window->_hx___width) ));
HXLINE(1792)			return 1;
            		}
            		HX_END_LOCAL_FUNC2(return)

            		HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_3) HXARGC(2)
            		int _hx_run( cpp::Reference<lua_State> l, ::Dynamic data){
            			HX_GC_STACKFRAME(&_hx_pos_bc049608668cd482_1800_new)
HXLINE(1801)			lua_pushnumber(l,( (Float)(::lime::app::Application_obj::current->_hx___window->_hx___height) ));
HXLINE(1802)			return 1;
            		...
            		int _hx_run( cpp::Reference<lua_State> l, ::Dynamic data){
            			HX_GC_STACKFRAME(&_hx_pos_bc049608668cd482_1810_new)
HXLINE(1811)			linc::lua::pushcfunction(l,::LuaWindow_obj::tweenPosC);
HXLINE(1812)			return 1;
            		...
            		int _hx_run( cpp::Reference<lua_State> l){
            			HX_GC_STACKFRAME(&_hx_pos_bc049608668cd482_1815_new)
HXLINE(1816)			linc::lual::error(l,HX_("tweenPos is read-only.",ca,97,f3,17));
HXLINE(1817)			return 0;
            		}
            		HX_END_LOCAL_FUNC1(return)

            	HX_GC_STACKFRAME(&_hx_pos_bc049608668cd482_1762_new)
HXLINE(1763)		super::__construct();
HXLINE(1764)		this->className = HX_("Window",10,08,21,87);
HXLINE(1766)		 ::haxe::ds::StringMap _g =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
HXDLIN(1766)		_g->set(HX_("x",78,00,00,00), ::Dynamic(::hx::Anon_obj::Create(3)
...
HXDLIN(1766)		_g->set(HX_("y",79,00,00,00), ::Dynamic(::hx::Anon_obj::Create(3)
            			...
            			->setFixed(2,HX_("setter",7f,33,88,6f),this->SetNumProperty_dyn())));
HXDLIN(1766)		_g->set(HX_("width",06,b6,62,ca), ::Dynamic(::hx::Anon_obj::Create(3)
            			...
            			->setFixed(2,HX_("setter",7f,33,88,6f),this->SetNumProperty_dyn())));
HXDLIN(1766)		_g->set(HX_("height",e7,07,4c,02), ::Dynamic(::hx::Anon_obj::Create(3)
            			...
            			->setFixed(2,HX_("setter",7f,33,88,6f),this->SetNumProperty_dyn())));
HXDLIN(1766)		_g->set(HX_("tweenPos",e9,7f,cc,11), ::Dynamic(::hx::Anon_obj::Create(3)
...
HXDLIN(1766)		this->properties = _g;
            	}
...
int LuaWindow_obj::SetNumProperty( cpp::Reference<lua_State> l){
            	HX_STACKFRAME(&_hx_pos_bc049608668cd482_1841_SetNumProperty)
HXLINE(1846)		if ((lua_type(l,3) != 3)) {
HXLINE(1848)			linc::lual::error(l,((HX_("invalid argument #3 (number expected, got ",25,84,c0,d9) + linc::lua::_typename(l,lua_type(l,3))) + HX_(")",29,00,00,00)));
HXLINE(1849)			return 0;
            		}
HXLINE(1851)		 ::lime::ui::Window _hx_tmp = ::lime::app::Application_obj::current->_hx___window;
HXDLIN(1851)		::String _hx_tmp1 = linc::lua::tostring(l,2);
HXDLIN(1851)		::Reflect_obj::setProperty(_hx_tmp,_hx_tmp1,lua_tonumber(l,3));
HXLINE(1852)		return 0;
            	}
...
void LuaWindow_obj::Register( cpp::Reference<lua_State> l){
            	HX_STACKFRAME(&_hx_pos_bc049608668cd482_1856_Register)
HXLINE(1857)		::LuaWindow_obj::state = l;
HXLINE(1858)		this->super::Register(l);
            	}
...
int LuaWindow_obj::tweenPos( lua_State* l){
            	HX_STACKFRAME(&_hx_pos_bc049608668cd482_1824_tweenPos)
HXLINE(1829)		Float xp = luaL_checknumber(::LuaWindow_obj::state,2);
HXLINE(1830)		Float yp = luaL_checknumber(::LuaWindow_obj::state,3);
HXLINE(1831)		Float time = luaL_checknumber(::LuaWindow_obj::state,4);
HXLINE(1833)		::flixel::tweens::FlxTween_obj::tween(::lime::app::Application_obj::current->_hx___window, ::Dynamic(::hx::Anon_obj::Create(2)
            			->setFixed(0,HX_("x",78,00,00,00),xp)
            			->setFixed(1,HX_("y",79,00,00,00),yp)),time,null());
HXLINE(1835)		return 0;
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_bc049608668cd482_1838_boot)
HXDLIN(1838)		tweenPosC = ::cpp::Function< int ( lua_State*)>(::hx::AnyCast(&::LuaWindow_obj::tweenPos ));
            	}
}
