...
HX_DEFINE_STACK_FRAME(_hx_pos_e4baa538405dcd60_12_new,"OptionsDirect","new",0x43d34d79,"OptionsDirect.new","OptionsDirect.hx",12,0x6d5cc417)
HX_LOCAL_STACK_FRAME(_hx_pos_e4baa538405dcd60_37_create,"OptionsDirect","create",0xe2225f83,"OptionsDirect.create","OptionsDirect.hx",37,0x6d5cc417)
HX_LOCAL_STACK_FRAME(_hx_pos_e4baa538405dcd60_15_create,"OptionsDirect","create",0xe2225f83,"OptionsDirect.create","OptionsDirect.hx",15,0x6d5cc417)
...
void OptionsDirect_obj::__construct( ::flixel::addons::transition::TransitionData TransIn, ::flixel::addons::transition::TransitionData TransOut){
            	HX_STACKFRAME(&_hx_pos_e4baa538405dcd60_12_new)
...
void OptionsDirect_obj::create(){
            		...
            		void _hx_run( ::flixel::util::FlxTimer tmr){
            			HX_GC_STACKFRAME(&_hx_pos_e4baa538405dcd60_37_create)
HXLINE(  38)			 ::flixel::FlxSprite menuBG = menuBG1;
HXDLIN(  38)			int menuBG2 = menuBG1->color;
HXDLIN(  38)			::flixel::tweens::FlxTween_obj::color(menuBG,2,menuBG2,( (int)(::flixel::util::_FlxColor::FlxColor_Impl__obj::fromString(bgColors->__get(colorRotation->__get(0)))) ),null());
HXLINE(  39)			if ((colorRotation->__get(0) < (bgColors->length - 1))) {
HXLINE(  40)				colorRotation[0]++;
            			}
            			else {
HXLINE(  42)				colorRotation[0] = 0;
            			}
            		}
            		HX_END_LOCAL_FUNC1((void))

            	HX_GC_STACKFRAME(&_hx_pos_e4baa538405dcd60_15_create)
HXLINE(  18)		this->transIn = ::flixel::addons::transition::FlxTransitionableState_obj::defaultTransIn;
HXLINE(  19)		this->transOut = ::flixel::addons::transition::FlxTransitionableState_obj::defaultTransOut;
HXLINE(  21)		this->persistentUpdate = true;
HXLINE(  23)		::Array< ::String > bgColors = ::Array_obj< ::String >::fromData( _hx_array_data_36f71d07_3,4);
HXLINE(  24)		::Array< int > colorRotation = ::Array_obj< int >::fromData( _hx_array_data_36f71d07_4,1);
HXLINE(  26)		 ::flixel::FlxSprite menuBG =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,null(),null(),null());
HXDLIN(  26)		 ::flixel::FlxSprite menuBG1 = menuBG->loadGraphic(::Paths_obj::loadImage(HX_("menuDesat",26,91,04,72),null()),null(),null(),null(),null(),null());
HXLINE(  28)		 ::flixel::FlxSprite menuBG2 = menuBG1;
HXDLIN(  28)		menuBG2->setGraphicSize(::Std_obj::_hx_int((menuBG1->get_width() * ((Float)1.1))),null());
HXLINE(  29)		menuBG1->updateHitbox();
HXLINE(  30)		{
...
HXLINE(  30)				 ::flixel::FlxSprite menuBG = menuBG1;
HXDLIN(  30)				int _hx_tmp = ::flixel::FlxG_obj::width;
HXDLIN(  30)				menuBG->set_x(((( (Float)(_hx_tmp) ) - menuBG1->get_width()) / ( (Float)(2) )));
            			}
...
HXLINE(  30)				 ::flixel::FlxSprite menuBG = menuBG1;
HXDLIN(  30)				int _hx_tmp = ::flixel::FlxG_obj::height;
HXDLIN(  30)				menuBG->set_y(((( (Float)(_hx_tmp) ) - menuBG1->get_height()) / ( (Float)(2) )));
            			}
            		}
HXLINE(  31)		menuBG1->set_antialiasing(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("antialiasing",f4,16,b3,48),::hx::paccDynamic)) ));
HXLINE(  32)		this->add(menuBG1);
HXLINE(  34)		 ::flixel::FlxSprite menuBG3 = menuBG1;
HXDLIN(  34)		int menuBG4 = menuBG1->color;
HXDLIN(  34)		::flixel::tweens::FlxTween_obj::color(menuBG3,2,menuBG4,( (int)(::flixel::util::_FlxColor::FlxColor_Impl__obj::fromString(bgColors->__get(colorRotation->__get(0)))) ),null());
HXLINE(  36)		 ::flixel::util::FlxTimer_obj::__alloc( HX_CTX ,null())->start(2, ::Dynamic(new _hx_Closure_0(bgColors,colorRotation,menuBG1)),0);
HXLINE(  45)		this->openSubState( ::OptionsMenu_obj::__alloc( HX_CTX ,null()));
            	}
