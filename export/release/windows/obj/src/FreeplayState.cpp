...
HX_LOCAL_STACK_FRAME(_hx_pos_86166a84e8de7ace_481_loadAnimDebug,"FreeplayState","loadAnimDebug",0xdf551f7f,"FreeplayState.loadAnimDebug","FreeplayState.hx",481,0x0d86f62d)
HX_LOCAL_STACK_FRAME(_hx_pos_86166a84e8de7ace_502_loadSong,"FreeplayState","loadSong",0xe7d343f8,"FreeplayState.loadSong","FreeplayState.hx",502,0x0d86f62d)
HX_LOCAL_STACK_FRAME(_hx_pos_86166a84e8de7ace_562_changeDiff,"FreeplayState","changeDiff",0x302511b2,"FreeplayState.changeDiff","FreeplayState.hx",562,0x0d86f62d)
HX_LOCAL_STACK_FRAME(_hx_pos_86166a84e8de7ace_609_changeSelection,"FreeplayState","changeSelection",0xbe8c8f7f,"FreeplayState.changeSelection","FreeplayState.hx",609,0x0d86f62d)
...
HX_LOCAL_STACK_FRAME(_hx_pos_86166a84e8de7ace_515_loadSongInFreePlay,"FreeplayState","loadSongInFreePlay",0x7b25afdd,"FreeplayState.loadSongInFreePlay","FreeplayState.hx",515,0x0d86f62d)
...
HXLINE( 227)		this->sprDifficulty->animation->play(HX_("easy",02,8c,0c,43),null(),null(),null());
HXLINE( 230)		this->difficultySelectors->add(this->sprDifficulty).StaticCast<  ::flixel::FlxSprite >();
...
HXLINE( 397)		if (upP) {
HXLINE( 399)			this->changeSelection(-1);
            		}
HXLINE( 401)		if (downP) {
HXLINE( 403)			this->changeSelection(1);
            		}
HXLINE( 409)		 ::flixel::input::keyboard::FlxKeyList _this6 = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->pressed) );
HXDLIN( 409)		if (_this6->keyManager->checkStatusUnsafe(16,_this6->status)) {
HXLINE( 411)			 ::flixel::input::keyboard::FlxKeyList _this = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->justPressed) );
HXDLIN( 411)			if (_this->keyManager->checkStatusUnsafe(37,_this->status)) {
HXLINE( 413)				 ::Dynamic _hx_tmp = ::hx::ClassOf< ::FreeplayState >();
HXDLIN( 413)				::FreeplayState_obj::rate = (::FreeplayState_obj::rate - ((Float)0.05));
HXLINE( 414)				 ::flixel::text::FlxText _hx_tmp1 = this->diffCalcText;
HXDLIN( 414)				_hx_tmp1->set_text((HX_("RATING: ",03,14,1b,b3) + ::DiffCalc_obj::CalculateDiff(::FreeplayState_obj::songData->get(::FreeplayState_obj::songs->__get(::FreeplayState_obj::curSelected).StaticCast<  ::FreeplaySongMetadata >()->songName)->__GetItem(::FreeplayState_obj::curDifficulty),null())));
            			}
HXLINE( 416)			 ::flixel::input::keyboard::FlxKeyList _this1 = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->justPressed) );
HXDLIN( 416)			if (_this1->keyManager->checkStatusUnsafe(39,_this1->status)) {
HXLINE( 418)				 ::Dynamic _hx_tmp = ::hx::ClassOf< ::FreeplayState >();
HXDLIN( 418)				::FreeplayState_obj::rate = (::FreeplayState_obj::rate + ((Float)0.05));
HXLINE( 419)				 ::flixel::text::FlxText _hx_tmp1 = this->diffCalcText;
HXDLIN( 419)				_hx_tmp1->set_text((HX_("RATING: ",03,14,1b,b3) + ::DiffCalc_obj::CalculateDiff(::FreeplayState_obj::songData->get(::FreeplayState_obj::songs->__get(::FreeplayState_obj::curSelected).StaticCast<  ::FreeplaySongMetadata >()->songName)->__GetItem(::FreeplayState_obj::curDifficulty),null())));
            			}
HXLINE( 422)			 ::flixel::input::keyboard::FlxKeyList _this2 = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->justPressed) );
HXDLIN( 422)			if (_this2->keyManager->checkStatusUnsafe(82,_this2->status)) {
HXLINE( 424)				::FreeplayState_obj::rate = ( (Float)(1) );
HXLINE( 425)				 ::flixel::text::FlxText _hx_tmp = this->diffCalcText;
HXDLIN( 425)				_hx_tmp->set_text((HX_("RATING: ",03,14,1b,b3) + ::DiffCalc_obj::CalculateDiff(::FreeplayState_obj::songData->get(::FreeplayState_obj::songs->__get(::FreeplayState_obj::curSelected).StaticCast<  ::FreeplaySongMetadata >()->songName)->__GetItem(::FreeplayState_obj::curDifficulty),null())));
            			}
HXLINE( 428)			if ((::FreeplayState_obj::rate > 3)) {
HXLINE( 430)				::FreeplayState_obj::rate = ( (Float)(3) );
HXLINE( 431)				 ::flixel::text::FlxText _hx_tmp = this->diffCalcText;
HXDLIN( 431)				_hx_tmp->set_text((HX_("RATING: ",03,14,1b,b3) + ::DiffCalc_obj::CalculateDiff(::FreeplayState_obj::songData->get(::FreeplayState_obj::songs->__get(::FreeplayState_obj::curSelected).StaticCast<  ::FreeplaySongMetadata >()->songName)->__GetItem(::FreeplayState_obj::curDifficulty),null())));
            			}
            			else {
HXLINE( 433)				if ((::FreeplayState_obj::rate < ((Float)0.5))) {
HXLINE( 435)					::FreeplayState_obj::rate = ((Float)0.5);
HXLINE( 436)					 ::flixel::text::FlxText _hx_tmp = this->diffCalcText;
HXDLIN( 436)					_hx_tmp->set_text((HX_("RATING: ",03,14,1b,b3) + ::DiffCalc_obj::CalculateDiff(::FreeplayState_obj::songData->get(::FreeplayState_obj::songs->__get(::FreeplayState_obj::curSelected).StaticCast<  ::FreeplaySongMetadata >()->songName)->__GetItem(::FreeplayState_obj::curDifficulty),null())));
            				}
            			}
HXLINE( 439)			 ::flixel::text::FlxText _hx_tmp = this->previewtext;
HXDLIN( 439)			_hx_tmp->set_text(((HX_("Rate: ",a6,71,1b,f0) + ::flixel::math::FlxMath_obj::roundDecimal(::FreeplayState_obj::rate,2)) + HX_("x",78,00,00,00)));
            		}
            		else {
HXLINE( 443)			 ::flixel::input::keyboard::FlxKeyList _this = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->justPressed) );
HXDLIN( 443)			if (_this->keyManager->checkStatusUnsafe(37,_this->status)) {
HXLINE( 444)				this->changeDiff(-1);
            			}
HXLINE( 445)			 ::flixel::input::keyboard::FlxKeyList _this1 = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->justPressed) );
HXDLIN( 445)			if (_this1->keyManager->checkStatusUnsafe(39,_this1->status)) {
HXLINE( 446)				this->changeDiff(1);
            			}
            		}
HXLINE( 452)		if (::hx::IsNotNull( ::flixel::FlxG_obj::sound->music->_channel )) {
HXLINE( 453)			::lime::media::openal::AL_obj::sourcef(::flixel::FlxG_obj::sound->music->_channel->_hx___source->_hx___backend->handle,4099,::FreeplayState_obj::rate);
            		}
HXLINE( 457)		if (::PlayerSettings_obj::player1->controls->_back->check()) {
HXLINE( 459)			 ::flixel::FlxState nextState =  ::MainMenuState_obj::__alloc( HX_CTX ,null(),null());
HXDLIN( 459)			if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE( 459)				::flixel::FlxG_obj::game->_requestedState = nextState;
            			}
            		}
HXLINE( 462)		if (accepted) {
HXLINE( 463)			this->loadSong(null());
            		}
            		else {
HXLINE( 464)			if (charting) {
HXLINE( 465)				this->loadSong(true);
            			}
            		}
            	}
...
void FreeplayState_obj::loadAnimDebug(::hx::Null< bool >  __o_dad){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_86166a84e8de7ace_481_loadAnimDebug)
HXLINE( 483)		 ::Dynamic hmm;
HXLINE( 484)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 486)			hmm = ::FreeplayState_obj::songData->get(::FreeplayState_obj::songs->__get(::FreeplayState_obj::curSelected).StaticCast<  ::FreeplaySongMetadata >()->songName)->__GetItem(::FreeplayState_obj::curDifficulty);
HXLINE( 487)			if (::hx::IsNull( hmm )) {
HXLINE( 488)				return;
            			}
            		} catch( ::Dynamic _hx_e) {
...
HXLINE( 494)		::PlayState_obj::SONG = hmm;
HXLINE( 496)		::String character;
HXDLIN( 496)		if (dad) {
HXLINE( 496)			character = ( (::String)(::PlayState_obj::SONG->__Field(HX_("player2",b1,09,15,8a),::hx::paccDynamic)) );
            		}
            		else {
HXLINE( 496)			character = ( (::String)(::PlayState_obj::SONG->__Field(HX_("player1",b0,09,15,8a),::hx::paccDynamic)) );
            		}
HXLINE( 498)		{
HXLINE( 498)			 ::flixel::FlxState nextState = ::LoadingState_obj::getNextState(( ( ::flixel::FlxState)( ::AnimationDebug_obj::__alloc( HX_CTX ,character)) ),false);
HXDLIN( 498)			if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE( 498)				::flixel::FlxG_obj::game->_requestedState = nextState;
            			}
            		}
            	}
...
void FreeplayState_obj::loadSong(::hx::Null< bool >  __o_isCharting){
            	...
            	HX_STACKFRAME(&_hx_pos_86166a84e8de7ace_502_loadSong)
HXLINE( 503)		::FreeplayState_obj::loadSongInFreePlay(::FreeplayState_obj::songs->__get(::FreeplayState_obj::curSelected).StaticCast<  ::FreeplaySongMetadata >()->songName,::FreeplayState_obj::curDifficulty,isCharting,null());
HXLINE( 505)		this->clean();
            	}
...
void FreeplayState_obj::changeDiff(::hx::Null< int >  __o_change){
            	...
            	HX_STACKFRAME(&_hx_pos_86166a84e8de7ace_562_changeDiff)
HXLINE( 563)		::Array< ::String > _hx_tmp = ::FreeplayState_obj::songs->__get(::FreeplayState_obj::curSelected).StaticCast<  ::FreeplaySongMetadata >()->diffs;
HXDLIN( 563)		if (!(_hx_tmp->contains(::CoolUtil_obj::difficultyFromInt((::FreeplayState_obj::curDifficulty + change))))) {
HXLINE( 564)			return;
            		}
HXLINE( 566)		 ::Dynamic _hx_tmp1 = ::hx::ClassOf< ::FreeplayState >();
HXDLIN( 566)		::FreeplayState_obj::curDifficulty = (::FreeplayState_obj::curDifficulty + change);
HXLINE( 568)		if ((::FreeplayState_obj::curDifficulty < 0)) {
HXLINE( 569)			::FreeplayState_obj::curDifficulty = 2;
            		}
HXLINE( 570)		if ((::FreeplayState_obj::curDifficulty > 3)) {
HXLINE( 571)			::FreeplayState_obj::curDifficulty = 0;
            		}
HXLINE( 574)		::String songHighscore = ::StringTools_obj::replace(::FreeplayState_obj::songs->__get(::FreeplayState_obj::curSelected).StaticCast<  ::FreeplaySongMetadata >()->songName,HX_(" ",20,00,00,00),HX_("-",2d,00,00,00));
HXLINE( 575)		::String _hx_switch_0 = songHighscore;
            		if (  (_hx_switch_0==HX_("Dad-Battle",fe,4d,ac,32)) ){
HXLINE( 578)			songHighscore = HX_("Dadbattle",9f,4a,7c,48);
HXDLIN( 578)			goto _hx_goto_12;
            		}
            		if (  (_hx_switch_0==HX_("M.I.L.F",1e,4e,41,0d)) ){
HXLINE( 582)			songHighscore = HX_("Milf",f6,78,35,33);
HXDLIN( 582)			goto _hx_goto_12;
            		}
            		if (  (_hx_switch_0==HX_("Philly-Nice",22,f2,31,13)) ){
HXLINE( 580)			songHighscore = HX_("Philly",48,eb,f2,23);
HXDLIN( 580)			goto _hx_goto_12;
            		}
            		_hx_goto_12:;
HXLINE( 584)		switch((int)(::FreeplayState_obj::curDifficulty)){
            			case (int)0: {
HXLINE( 587)				this->sprDifficulty->animation->play(HX_("easy",02,8c,0c,43),null(),null(),null());
HXLINE( 588)				this->sprDifficulty->offset->set_x(( (Float)(20) ));
            			}
            			break;
            			case (int)1: {
HXLINE( 590)				this->sprDifficulty->animation->play(HX_("normal",27,72,69,30),null(),null(),null());
HXLINE( 591)				this->sprDifficulty->offset->set_x(( (Float)(70) ));
            			}
            			break;
            			case (int)2: {
HXLINE( 593)				this->sprDifficulty->animation->play(HX_("hard",eb,2e,08,45),null(),null(),null());
HXLINE( 594)				this->sprDifficulty->offset->set_x(( (Float)(20) ));
            			}
            			break;
            			case (int)3: {
HXLINE( 596)				this->sprDifficulty->animation->play(HX_("insane",aa,36,da,9d),null(),null(),null());
HXLINE( 597)				this->sprDifficulty->offset->set_x(( (Float)(20) ));
            			}
            			break;
            		}
HXLINE( 601)		this->intendedScore = ::Highscore_obj::getScore(songHighscore,::FreeplayState_obj::curDifficulty);
HXLINE( 602)		this->combo = ::Highscore_obj::getCombo(songHighscore,::FreeplayState_obj::curDifficulty);
HXLINE( 604)		 ::flixel::text::FlxText _hx_tmp2 = this->diffCalcText;
HXDLIN( 604)		_hx_tmp2->set_text((HX_("RATING: ",03,14,1b,b3) + ::DiffCalc_obj::CalculateDiff(::FreeplayState_obj::songData->get(::FreeplayState_obj::songs->__get(::FreeplayState_obj::curSelected).StaticCast<  ::FreeplaySongMetadata >()->songName)->__GetItem(::FreeplayState_obj::curDifficulty),null())));
HXLINE( 605)		 ::flixel::text::FlxText _hx_tmp3 = this->diffText;
HXDLIN( 605)		_hx_tmp3->set_text(::CoolUtil_obj::difficultyFromInt(::FreeplayState_obj::curDifficulty).toUpperCase());
            	}
...
void FreeplayState_obj::changeSelection(::hx::Null< int >  __o_change){
            		int change = __o_change.Default(0);
            	HX_GC_STACKFRAME(&_hx_pos_86166a84e8de7ace_609_changeSelection)
HXLINE( 610)		 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 610)		_hx_tmp->play(::Paths_obj::sound(HX_("scrollMenu",4c,d4,18,06),null()),((Float)0.4),null(),null(),null(),null());
HXLINE( 612)		 ::Dynamic _hx_tmp1 = ::hx::ClassOf< ::FreeplayState >();
HXDLIN( 612)		::FreeplayState_obj::curSelected = (::FreeplayState_obj::curSelected + change);
HXLINE( 614)		if ((::FreeplayState_obj::curSelected < 0)) {
HXLINE( 615)			::FreeplayState_obj::curSelected = (::FreeplayState_obj::songs->length - 1);
            		}
HXLINE( 616)		if ((::FreeplayState_obj::curSelected >= ::FreeplayState_obj::songs->length)) {
HXLINE( 617)			::FreeplayState_obj::curSelected = 0;
            		}
HXLINE( 619)		this->remove(this->bg,null());
HXLINE( 620)		 ::flixel::FlxSprite _hx_tmp2 = this->bg;
HXDLIN( 620)		_hx_tmp2->loadGraphic(::Paths_obj::loadImage(((HX_("songImages/",22,a9,00,7a) + ::FreeplayState_obj::songs->__get(::FreeplayState_obj::curSelected).StaticCast<  ::FreeplaySongMetadata >()->songName) + HX_("freeplayimage",bb,4a,32,12)),null()),null(),null(),null(),null(),null());
HXLINE( 621)		this->add(this->bg);
HXLINE( 622)		if ((::FreeplayState_obj::songs->__get(::FreeplayState_obj::curSelected).StaticCast<  ::FreeplaySongMetadata >()->diffs->length != 3)) {
HXLINE( 624)			::String _hx_switch_0 = ::FreeplayState_obj::songs->__get(::FreeplayState_obj::curSelected).StaticCast<  ::FreeplaySongMetadata >()->diffs->__get(0);
            			if (  (_hx_switch_0==HX_("Easy",22,b8,e5,2d)) ){
HXLINE( 627)				::FreeplayState_obj::curDifficulty = 0;
HXDLIN( 627)				goto _hx_goto_14;
            			}
            			if (  (_hx_switch_0==HX_("Hard",0b,5b,e1,2f)) ){
HXLINE( 631)				::FreeplayState_obj::curDifficulty = 2;
HXDLIN( 631)				goto _hx_goto_14;
            			}
            			if (  (_hx_switch_0==HX_("Insane",ca,aa,6e,d2)) ){
HXLINE( 633)				::FreeplayState_obj::curDifficulty = 3;
HXDLIN( 633)				goto _hx_goto_14;
            			}
            			if (  (_hx_switch_0==HX_("Normal",47,e6,fd,64)) ){
HXLINE( 629)				::FreeplayState_obj::curDifficulty = 1;
HXDLIN( 629)				goto _hx_goto_14;
            			}
            			_hx_goto_14:;
            		}
HXLINE( 641)		::String songHighscore = ::StringTools_obj::replace(::FreeplayState_obj::songs->__get(::FreeplayState_obj::curSelected).StaticCast<  ::FreeplaySongMetadata >()->songName,HX_(" ",20,00,00,00),HX_("-",2d,00,00,00));
HXLINE( 642)		::String _hx_switch_1 = songHighscore;
            		if (  (_hx_switch_1==HX_("Dad-Battle",fe,4d,ac,32)) ){
HXLINE( 645)			songHighscore = HX_("Dadbattle",9f,4a,7c,48);
HXDLIN( 645)			goto _hx_goto_15;
            		}
            		if (  (_hx_switch_1==HX_("M.I.L.F",1e,4e,41,0d)) ){
HXLINE( 649)			songHighscore = HX_("Milf",f6,78,35,33);
HXDLIN( 649)			goto _hx_goto_15;
            		}
            		if (  (_hx_switch_1==HX_("Philly-Nice",22,f2,31,13)) ){
HXLINE( 647)			songHighscore = HX_("Philly",48,eb,f2,23);
HXDLIN( 647)			goto _hx_goto_15;
            		}
            		_hx_goto_15:;
HXLINE( 653)		this->intendedScore = ::Highscore_obj::getScore(songHighscore,::FreeplayState_obj::curDifficulty);
HXLINE( 654)		this->combo = ::Highscore_obj::getCombo(songHighscore,::FreeplayState_obj::curDifficulty);
HXLINE( 658)		 ::flixel::text::FlxText _hx_tmp3 = this->diffCalcText;
HXDLIN( 658)		_hx_tmp3->set_text((HX_("RATING: ",03,14,1b,b3) + ::DiffCalc_obj::CalculateDiff(::FreeplayState_obj::songData->get(::FreeplayState_obj::songs->__get(::FreeplayState_obj::curSelected).StaticCast<  ::FreeplaySongMetadata >()->songName)->__GetItem(::FreeplayState_obj::curDifficulty),null())));
HXLINE( 659)		 ::flixel::text::FlxText _hx_tmp4 = this->diffText;
HXDLIN( 659)		_hx_tmp4->set_text(::CoolUtil_obj::difficultyFromInt(::FreeplayState_obj::curDifficulty).toUpperCase());
HXLINE( 662)		if ((::FreeplayState_obj::songs->__get(::FreeplayState_obj::curSelected).StaticCast<  ::FreeplaySongMetadata >()->songCharacter == HX_("sm",9a,64,00,00))) {
HXLINE( 664)			 ::FreeplaySongMetadata data = ::FreeplayState_obj::songs->__get(::FreeplayState_obj::curSelected).StaticCast<  ::FreeplaySongMetadata >();
HXLINE( 666)			 ::haxe::io::Bytes bytes = ::sys::io::File_obj::getBytes(((data->path + HX_("/",2f,00,00,00)) + data->sm->header->MUSIC));
HXLINE( 667)			 ::openfl::media::Sound sound =  ::openfl::media::Sound_obj::__alloc( HX_CTX ,null(),null());
HXLINE( 668)			sound->loadCompressedDataFromByteArray(::openfl::utils::_ByteArray::ByteArray_Impl__obj::fromBytesData(bytes->b),bytes->length);
HXLINE( 669)			::flixel::FlxG_obj::sound->playMusic(sound,null(),null(),null());
            		}
            		else {
HXLINE( 672)			 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 672)			::String songLowercase = ::StringTools_obj::replace(::FreeplayState_obj::songs->__get(::FreeplayState_obj::curSelected).StaticCast<  ::FreeplaySongMetadata >()->songName,HX_(" ",20,00,00,00),HX_("-",2d,00,00,00)).toLowerCase();
HXDLIN( 672)			::String _hx_switch_2 = songLowercase;
            			if (  (_hx_switch_2==HX_("dad-battle",be,d5,66,07)) ){
HXLINE( 672)				songLowercase = HX_("dadbattle",bf,6a,a9,a6);
HXDLIN( 672)				goto _hx_goto_16;
            			}
            			if (  (_hx_switch_2==HX_("m.i.l.f",9e,fe,da,ac)) ){
HXLINE( 672)				songLowercase = HX_("milf",d6,4c,5c,48);
HXDLIN( 672)				goto _hx_goto_16;
            			}
            			if (  (_hx_switch_2==HX_("philly-nice",22,2e,26,44)) ){
HXLINE( 672)				songLowercase = HX_("philly",28,77,5e,ef);
HXDLIN( 672)				goto _hx_goto_16;
            			}
            			_hx_goto_16:;
HXDLIN( 672)			_hx_tmp->playMusic((((HX_("songs:assets/songs/",c1,ed,e6,7e) + songLowercase) + HX_("/Inst.",f9,6e,13,1c)) + HX_("ogg",4f,94,54,00)),0,null(),null());
            		}
HXLINE( 675)		 ::Dynamic hmm;
HXLINE( 676)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 678)			hmm = ::FreeplayState_obj::songData->get(::FreeplayState_obj::songs->__get(::FreeplayState_obj::curSelected).StaticCast<  ::FreeplaySongMetadata >()->songName)->__GetItem(::FreeplayState_obj::curDifficulty);
HXLINE( 679)			if (::hx::IsNotNull( hmm )) {
HXLINE( 681)				::Conductor_obj::changeBPM(( (Float)(hmm->__Field(HX_("bpm",df,be,4a,00),::hx::paccDynamic)) ),null());
HXLINE( 682)				::GameplayCustomizeState_obj::freeplayBf = ( (::String)(hmm->__Field(HX_("player1",b0,09,15,8a),::hx::paccDynamic)) );
HXLINE( 683)				::GameplayCustomizeState_obj::freeplayDad = ( (::String)(hmm->__Field(HX_("player2",b1,09,15,8a),::hx::paccDynamic)) );
HXLINE( 684)				::GameplayCustomizeState_obj::freeplayGf = ( (::String)(hmm->__Field(HX_("gfVersion",b9,c6,7d,f3),::hx::paccDynamic)) );
HXLINE( 685)				::GameplayCustomizeState_obj::freeplayNoteStyle = ( (::String)(hmm->__Field(HX_("noteStyle",df,ef,aa,c1),::hx::paccDynamic)) );
HXLINE( 686)				::GameplayCustomizeState_obj::freeplayStage = ( (::String)(hmm->__Field(HX_("stage",be,6a,0b,84),::hx::paccDynamic)) );
HXLINE( 687)				::GameplayCustomizeState_obj::freeplaySong = ( (::String)(hmm->__Field(HX_("songId",10,c3,88,2d),::hx::paccDynamic)) );
HXLINE( 688)				::GameplayCustomizeState_obj::freeplayWeek = ::FreeplayState_obj::songs->__get(::FreeplayState_obj::curSelected).StaticCast<  ::FreeplaySongMetadata >()->week;
            			}
            		} catch( ::Dynamic _hx_e) {
            			if (_hx_e.IsClass<  ::Dynamic >() ){
            				HX_STACK_BEGIN_CATCH
...
HXLINE( 695)		if (::FreeplayState_obj::openedPreview) {
HXLINE( 697)			this->closeSubState();
HXLINE( 698)			this->openSubState( ::DiffOverview_obj::__alloc( HX_CTX ,null()));
            		}
HXLINE( 701)		int bullShit = 0;
HXLINE( 703)		{
HXLINE( 703)			int _g = 0;
HXDLIN( 703)			int _g1 = this->iconArray->length;
HXDLIN( 703)			while((_g < _g1)){
HXLINE( 703)				_g = (_g + 1);
HXDLIN( 703)				int i = (_g - 1);
HXLINE( 705)				this->iconArray->__get(i).StaticCast<  ::HealthIcon >()->set_alpha(((Float)0.6));
            			}
            		}
HXLINE( 708)		this->iconArray->__get(::FreeplayState_obj::curSelected).StaticCast<  ::HealthIcon >()->set_alpha(( (Float)(1) ));
HXLINE( 710)		{
HXLINE( 710)			int _g2 = 0;
HXDLIN( 710)			::Array< ::Dynamic> _g3 = this->grpSongs->members;
HXDLIN( 710)			while((_g2 < _g3->length)){
HXLINE( 710)				 ::Alphabet item = _g3->__get(_g2).StaticCast<  ::Alphabet >();
HXDLIN( 710)				_g2 = (_g2 + 1);
HXLINE( 712)				item->targetY = ( (Float)((bullShit - ::FreeplayState_obj::curSelected)) );
HXLINE( 713)				bullShit = (bullShit + 1);
HXLINE( 715)				item->set_alpha(((Float)0.6));
HXLINE( 718)				if ((item->targetY == 0)) {
HXLINE( 720)					item->set_alpha(( (Float)(1) ));
            				}
            			}
            		}
            	}
...
void FreeplayState_obj::loadSongInFreePlay(::String songName,int difficulty,bool isCharting,::hx::Null< bool >  __o_reloadSong){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_86166a84e8de7ace_515_loadSongInFreePlay)
HXLINE( 517)		bool _hx_tmp;
HXDLIN( 517)		if (::hx::IsNotNull( ::FreeplayState_obj::songData )) {
HXLINE( 517)			_hx_tmp = (::Lambda_obj::count(::FreeplayState_obj::songData,null()) == 0);
            		}
            		else {
HXLINE( 517)			_hx_tmp = true;
            		}
HXDLIN( 517)		if (_hx_tmp) {
HXLINE( 518)			::FreeplayState_obj::populateSongData();
            		}
HXLINE( 520)		 ::Dynamic currentSongData;
HXLINE( 521)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 523)			if (::hx::IsNull( ::FreeplayState_obj::songData->get(songName) )) {
HXLINE( 524)				return;
            			}
HXLINE( 525)			currentSongData = ::FreeplayState_obj::songData->get(songName)->__GetItem(difficulty);
HXLINE( 526)			if (::hx::IsNull( ::FreeplayState_obj::songData->get(songName)->__GetItem(difficulty) )) {
HXLINE( 527)				return;
            			}
            		} catch( ::Dynamic _hx_e) {
            			if (_hx_e.IsClass<  ::Dynamic >() ){
...
HXLINE( 534)		::PlayState_obj::SONG = currentSongData;
HXLINE( 535)		::PlayState_obj::isStoryMode = false;
HXLINE( 536)		::PlayState_obj::storyDifficulty = difficulty;
HXLINE( 537)		::PlayState_obj::storyWeek = ::FreeplayState_obj::songs->__get(::FreeplayState_obj::curSelected).StaticCast<  ::FreeplaySongMetadata >()->week;
HXLINE( 538)		{
HXLINE( 538)			 ::Dynamic input =  ::Dynamic(((((HX_("Loading song ",e7,e5,89,48) + ::PlayState_obj::SONG->__Field(HX_("songName",c0,d0,d7,36),::hx::paccDynamic)) + HX_(" from week ",96,1a,a7,bd)) + ::PlayState_obj::storyWeek) + HX_(" into Free Play...",66,d6,f9,2d)));
HXDLIN( 538)			if (::hx::IsNotNull( input )) {
HXLINE( 538)				::cpp::VirtualArray output = ::Debug_obj::formatOutput(input,::hx::SourceInfo(HX_("source/FreeplayState.hx",21,2d,b0,ce),538,HX_("FreeplayState",31,61,f2,b3),HX_("loadSongInFreePlay",c0,4a,da,0b)));
HXDLIN( 538)				::Debug_obj::writeToFlxGLog(output,::Debug_obj::LOG_STYLE_INFO);
HXDLIN( 538)				::Debug_obj::writeToLogFile(output,HX_("INFO",6e,00,7c,30));
            			}
            		}
HXLINE( 540)		if ((::FreeplayState_obj::songs->__get(::FreeplayState_obj::curSelected).StaticCast<  ::FreeplaySongMetadata >()->songCharacter == HX_("sm",9a,64,00,00))) {
HXLINE( 542)			{
HXLINE( 542)				 ::Dynamic input = HX_("Song is a StepMania song!",88,e7,b7,0a);
HXDLIN( 542)				if (::hx::IsNotNull( input )) {
HXLINE( 542)					::cpp::VirtualArray output = ::Debug_obj::formatOutput(input,::hx::SourceInfo(HX_("source/FreeplayState.hx",21,2d,b0,ce),542,HX_("FreeplayState",31,61,f2,b3),HX_("loadSongInFreePlay",c0,4a,da,0b)));
HXDLIN( 542)					::Debug_obj::writeToFlxGLog(output,::Debug_obj::LOG_STYLE_INFO);
HXDLIN( 542)					::Debug_obj::writeToLogFile(output,HX_("INFO",6e,00,7c,30));
            				}
            			}
HXLINE( 543)			::PlayState_obj::isSM = true;
HXLINE( 544)			::PlayState_obj::sm = ::FreeplayState_obj::songs->__get(::FreeplayState_obj::curSelected).StaticCast<  ::FreeplaySongMetadata >()->sm;
HXLINE( 545)			::PlayState_obj::pathToSm = ::FreeplayState_obj::songs->__get(::FreeplayState_obj::curSelected).StaticCast<  ::FreeplaySongMetadata >()->path;
            		}
            		else {
HXLINE( 548)			::PlayState_obj::isSM = false;
            		}
HXLINE( 553)		::PlayState_obj::songMultiplier = ::FreeplayState_obj::rate;
HXLINE( 555)		if (isCharting) {
HXLINE( 556)			 ::flixel::FlxState nextState = ::LoadingState_obj::getNextState(( ( ::flixel::FlxState)( ::ChartingState_obj::__alloc( HX_CTX ,reloadSong)) ),false);
HXDLIN( 556)			if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE( 556)				::flixel::FlxG_obj::game->_requestedState = nextState;
            			}
            		}
            		else {
