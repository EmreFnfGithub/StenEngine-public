...
HXLINE(  18)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("StenEngine",cc,3a,c1,8d),::ApplicationMain_obj::create_dyn());
...
HXLINE(  35)		app->meta->set(HX_("build",2e,db,ea,ba),HX_("1562",20,db,8b,20));
HXLINE(  36)		app->meta->set(HX_("company",3d,15,69,83),HX_("EmreFnF",83,82,d5,b0));
HXLINE(  37)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("StenEngine",cc,3a,c1,8d));
HXLINE(  38)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Friday Night Funkin': Sten Engine",65,11,9a,f3));
HXLINE(  39)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("com.emrefnf.stenengine",44,ca,3f,39));
...
HXLINE(  46)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Friday Night Funkin': Sten Engine",65,11,9a,f3))
