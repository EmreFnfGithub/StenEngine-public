...
HX_DEFINE_STACK_FRAME(_hx_pos_f5d92c5178b43db3_27_new,"StenEngineFPS","new",0x1590e882,"StenEngineFPS.new","StenEngineFPS.hx",27,0x99ed1d2e)
HX_LOCAL_STACK_FRAME(_hx_pos_f5d92c5178b43db3_87___enterFrame,"StenEngineFPS","__enterFrame",0x9b2752b3,"StenEngineFPS.__enterFrame","StenEngineFPS.hx",87,0x99ed1d2e)
HX_LOCAL_STACK_FRAME(_hx_pos_f5d92c5178b43db3_82_boot,"StenEngineFPS","boot",0xc15389d0,"StenEngineFPS.boot","StenEngineFPS.hx",82,0x99ed1d2e)
...
HXLINE( 116)					_hx_tmp1 = ((HX_("\nKE ",7c,47,d5,06) + HX_("v",76,00,00,00)) + ::MainMenuState_obj::StenEngineVer);
            				}
            				else {
...
HXLINE( 114)					_hx_tmp = ((HX_("KE ",46,25,39,00) + HX_("v",76,00,00,00)) + ::MainMenuState_obj::StenEngineVer);
            				}
            				else {
...
void StenEngineFPS_obj::__register()
{
	...
	__mClass->mName = HX_("StenEngineFPS",90,3f,96,4b);
