...
HXLINE(  24)		this->initialState = ::hx::ClassOf< ::StenEngineLoading >();
...
HXLINE(  98)		this->fpsCounter =  ::StenEngineFPS_obj::__alloc( HX_CTX ,10,3,16777215);
...
::hx::Val Main_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 10:
		...
		if (HX_FIELD_EQ(inName,"fpsCounter") ) { fpsCounter=inValue.Cast<  ::StenEngineFPS >(); return inValue; }
		break;
	case 12:
...
static ::hx::StorageInfo Main_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsObject /*  ::StenEngineFPS */ ,(int)offsetof(Main_obj,fpsCounter),HX_("fpsCounter",13,ce,9d,83)},
	{ ::hx::fsUnknown, 0, null()}
};
