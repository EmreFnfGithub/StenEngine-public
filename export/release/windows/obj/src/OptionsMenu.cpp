...
HXLINE( 126)		 ::RedesignedMenu _hx_tmp5 =  ::RedesignedMenu_obj::__alloc( HX_CTX ,HX_("Redesigned menu namely Sten Engine Menu",3e,62,ae,d6));
HXLINE( 127)		 ::RedesignedMenuTwo _hx_tmp6 =  ::RedesignedMenuTwo_obj::__alloc( HX_CTX ,HX_("Redesigned menu namely Sten Engine Menus",75,94,e7,01));
HXLINE( 128)		 ::EngineUsernameOption _hx_tmp7 =  ::EngineUsernameOption_obj::__alloc( HX_CTX ,HX_("Change your funkin sten engine name (Varies in each mode)",3f,ec,51,cb));
