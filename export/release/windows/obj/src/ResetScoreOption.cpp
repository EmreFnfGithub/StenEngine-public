...
HX_DEFINE_STACK_FRAME(_hx_pos_3ef98e6da45dca70_2041_new,"ResetScoreOption","new",0x5d8eefea,"ResetScoreOption.new","Options.hx",2041,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_3ef98e6da45dca70_2055_press,"ResetScoreOption","press",0x4271e98d,"ResetScoreOption.press","Options.hx",2055,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_3ef98e6da45dca70_2082_updateDisplay,"ResetScoreOption","updateDisplay",0x42963f43,"ResetScoreOption.updateDisplay","Options.hx",2082,0x9d9a0240)

void ResetScoreOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_3ef98e6da45dca70_2041_new)
HXLINE(2043)		this->confirm = false;
HXLINE(2047)		super::__construct();
HXLINE(2048)		if (::OptionsMenu_obj::isInPause) {
HXLINE(2049)			this->description = HX_("This option cannot be toggled in the pause menu.",b4,21,dd,c9);
            		}
            		else {
HXLINE(2051)			this->description = desc;
            		}
            	}
...
bool ResetScoreOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_3ef98e6da45dca70_2055_press)
HXLINE(2056)		if (::OptionsMenu_obj::isInPause) {
HXLINE(2057)			return false;
            		}
HXLINE(2058)		if (!(this->confirm)) {
HXLINE(2060)			this->confirm = true;
HXLINE(2061)			this->display = this->updateDisplay();
HXLINE(2062)			return true;
            		}
HXLINE(2064)		::flixel::FlxG_obj::save->data->__SetField(HX_("songScores",96,1a,f0,a0),null(),::hx::paccDynamic);
HXLINE(2065)		{
HXLINE(2065)			 ::Dynamic key = ::Highscore_obj::songScores->keys();
HXDLIN(2065)			while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(2065)				::String key1 = ( (::String)(key->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE(2067)				::Highscore_obj::songScores->set(key1,0);
            			}
            		}
HXLINE(2069)		::flixel::FlxG_obj::save->data->__SetField(HX_("songCombos",1a,c2,aa,22),null(),::hx::paccDynamic);
HXLINE(2070)		{
HXLINE(2070)			 ::Dynamic key1 = ::Highscore_obj::songCombos->keys();
HXDLIN(2070)			while(( (bool)(key1->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(2070)				::String key = ( (::String)(key1->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE(2072)				::Highscore_obj::songCombos->set(key,HX_("",00,00,00,00));
            			}
            		}
HXLINE(2074)		this->confirm = false;
HXLINE(2076)		this->display = this->updateDisplay();
HXLINE(2077)		return true;
            	}


::String ResetScoreOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_3ef98e6da45dca70_2082_updateDisplay)
HXDLIN(2082)		if (this->confirm) {
HXDLIN(2082)			return HX_("Confirm Score Reset",01,e3,61,66);
            		}
            		else {
HXDLIN(2082)			return HX_("Reset Score",01,16,25,27);
            		}
HXDLIN(2082)		return null();
            	}
