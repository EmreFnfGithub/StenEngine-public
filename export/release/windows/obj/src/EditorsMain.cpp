...
HX_LOCAL_STACK_FRAME(_hx_pos_eec349df0935cb05_58_create,"EditorsMain","create",0xff897a2b,"EditorsMain.create","EditorsMain.hx",58,0x1e276abf)
HX_LOCAL_STACK_FRAME(_hx_pos_eec349df0935cb05_64_create,"EditorsMain","create",0xff897a2b,"EditorsMain.create","EditorsMain.hx",64,0x1e276abf)
HX_LOCAL_STACK_FRAME(_hx_pos_eec349df0935cb05_71_create,"EditorsMain","create",0xff897a2b,"EditorsMain.create","EditorsMain.hx",71,0x1e276abf)
HX_LOCAL_STACK_FRAME(_hx_pos_eec349df0935cb05_76_create,"EditorsMain","create",0xff897a2b,"EditorsMain.create","EditorsMain.hx",76,0x1e276abf)
...
HX_LOCAL_STACK_FRAME(_hx_pos_eec349df0935cb05_90_update,"EditorsMain","update",0x0a7f9938,"EditorsMain.update","EditorsMain.hx",90,0x1e276abf)
HX_LOCAL_STACK_FRAME(_hx_pos_eec349df0935cb05_94_stageEditorFunc,"EditorsMain","stageEditorFunc",0xaad24ae0,"EditorsMain.stageEditorFunc","EditorsMain.hx",94,0x1e276abf)

void EditorsMain_obj::__construct( ::Dynamic BGColor){
            	HX_STACKFRAME(&_hx_pos_eec349df0935cb05_34_new)
HXDLIN(  34)		super::__construct(BGColor);
            	}
...
HXLINE(  54)			 ::flixel::FlxState nextState =  ::StageEditor_obj::__alloc( HX_CTX ,null(),null());
...
HXLINE(  54)				::flixel::FlxG_obj::game->_requestedState = nextState;
            		...
            		void _hx_run(){
            			HX_GC_STACKFRAME(&_hx_pos_eec349df0935cb05_58_create)
HXLINE(  59)			::MainMenuState_obj::Editorsnull = true;
HXLINE(  60)			{
HXLINE(  60)				 ::flixel::FlxState nextState =  ::MainMenuState_obj::__alloc( HX_CTX ,null(),null());
...
HXLINE(  60)					::flixel::FlxG_obj::game->_requestedState = nextState;
            		...
            		void _hx_run(){
            			HX_GC_STACKFRAME(&_hx_pos_eec349df0935cb05_64_create)
HXLINE(  65)			::MainMenuState_obj::Editorsnull = true;
HXLINE(  66)			{
...
HXLINE(  66)					::flixel::FlxG_obj::game->_requestedState = nextState;
            		...
            		void _hx_run(){
            			HX_GC_STACKFRAME(&_hx_pos_eec349df0935cb05_71_create)
HXLINE(  71)			 ::flixel::FlxState nextState =  ::miniGames::MiniGamesState_obj::__alloc( HX_CTX ,null(),null());
...
HXLINE(  71)				::flixel::FlxG_obj::game->_requestedState = nextState;
            		...
            		void _hx_run(){
            			HX_GC_STACKFRAME(&_hx_pos_eec349df0935cb05_76_create)
...
HXLINE(  81)			::MainMenuState_obj::Editorsnull = true;
HXLINE(  82)			{
...
HXLINE(  50)		this->bg->set_antialiasing(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("antialiasing",f4,16,b3,48),::hx::paccDynamic)) ));
HXLINE(  51)		this->add(this->bg);
HXLINE(  52)		::flixel::FlxG_obj::mouse->set_visible(true);
HXLINE(  53)		 ::flixel::ui::FlxButton button2 =  ::flixel::ui::FlxButton_obj::__alloc( HX_CTX ,35,105,HX_("Stage Editor",0f,63,39,a5), ::Dynamic(new _hx_Closure_0()));
HXLINE(  56)		this->add(button2);
HXLINE(  58)		 ::flixel::ui::FlxButton button3 =  ::flixel::ui::FlxButton_obj::__alloc( HX_CTX ,35,130,HX_("Character E",ee,8b,f1,a2), ::Dynamic(new _hx_Closure_1()));
HXLINE(  62)		this->add(button3);
HXLINE(  64)		 ::flixel::ui::FlxButton button4 =  ::flixel::ui::FlxButton_obj::__alloc( HX_CTX ,35,155,HX_("Week Editor",59,6c,6c,6d), ::Dynamic(new _hx_Closure_2()));
HXLINE(  68)		this->add(button4);
HXLINE(  70)		 ::flixel::ui::FlxButton button5 =  ::flixel::ui::FlxButton_obj::__alloc( HX_CTX ,35,180,HX_("Mini Games",f8,59,b4,ea), ::Dynamic(new _hx_Closure_3()));
HXLINE(  73)		this->add(button5);
HXLINE(  75)		 ::flixel::ui::FlxButton button6 =  ::flixel::ui::FlxButton_obj::__alloc( HX_CTX ,35,205,HX_("Other...",3e,87,5e,86), ::Dynamic(new _hx_Closure_4()));
HXLINE(  78)		this->add(button6);
HXLINE(  80)		 ::flixel::ui::FlxButton close =  ::flixel::ui::FlxButton_obj::__alloc( HX_CTX ,310,50,HX_("X",58,00,00,00), ::Dynamic(new _hx_Closure_5()));
HXLINE(  84)		close->set_color(-65536);
HXLINE(  85)		this->add(close);
HXLINE(  87)		this->super::create();
            	}


void EditorsMain_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_eec349df0935cb05_90_update)
HXDLIN(  90)		this->super::update(elapsed);
            	}


void EditorsMain_obj::stageEditorFunc(){
            	HX_STACKFRAME(&_hx_pos_eec349df0935cb05_94_stageEditorFunc)
            	}
...
::hx::ObjectPtr< EditorsMain_obj > EditorsMain_obj::__new( ::Dynamic BGColor) {
	::hx::ObjectPtr< EditorsMain_obj > __this = new EditorsMain_obj();
	__this->__construct(BGColor);
	return __this;
}

::hx::ObjectPtr< EditorsMain_obj > EditorsMain_obj::__alloc(::hx::Ctx *_hx_ctx, ::Dynamic BGColor) {
