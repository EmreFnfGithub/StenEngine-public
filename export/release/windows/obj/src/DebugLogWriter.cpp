...
HX_LOCAL_STACK_FRAME(_hx_pos_161373f69ee8fd30_393_isActive,"DebugLogWriter","isActive",0xc261cd5a,"DebugLogWriter.isActive","Debug.hx",393,0x6a71a26b)
HX_LOCAL_STACK_FRAME(_hx_pos_161373f69ee8fd30_412_shouldLog,"DebugLogWriter","shouldLog",0x281a5ec7,"DebugLogWriter.shouldLog","Debug.hx",412,0x6a71a26b)
HX_LOCAL_STACK_FRAME(_hx_pos_161373f69ee8fd30_421_setLogLevel,"DebugLogWriter","setLogLevel",0x888a4e58,"DebugLogWriter.setLogLevel","Debug.hx",421,0x6a71a26b)
HX_LOCAL_STACK_FRAME(_hx_pos_161373f69ee8fd30_435_write,"DebugLogWriter","write",0x66857295,"DebugLogWriter.write","Debug.hx",435,0x6a71a26b)
HX_LOCAL_STACK_FRAME(_hx_pos_161373f69ee8fd30_461_printDebug,"DebugLogWriter","printDebug",0x47c72d70,"DebugLogWriter.printDebug","Debug.hx",461,0x6a71a26b)
...
static const ::String _hx_array_data_840899a4_8[] = {
	HX_("STEN ERROR",52,d2,01,62),HX_("STEN WARN",dc,5e,77,34),HX_("STEN INFO",04,35,40,2b),HX_("STEN TRACE",0f,95,f7,04),
};
...
HXLINE( 368)			this->printDebug(HX_("Sten Engine Started! Welcome",8a,87,32,e0));
HXLINE( 369)			this->printDebug(HX_("----------------------------",40,2f,a0,da));
HXLINE( 370)			this->printDebug(HX_("Sten Engine Credits",b2,33,c5,79));
HXLINE( 371)			this->printDebug(HX_("- EmreFnF (Sten Engine Owner)",96,4b,c6,1b));
HXLINE( 372)			this->printDebug(HX_("- Behlul  (Sten Engine A few ideas)",13,eb,d4,68));
HXLINE( 373)			this->printDebug(HX_("----------------------------",40,2f,a0,da));
HXLINE( 374)			this->printDebug(HX_("Versions :",55,fb,dd,26));
HXLINE( 375)			this->printDebug((HX_("HaxeFlixel version: ",60,01,28,3e) + ::Std_obj::string(::flixel::FlxG_obj::VERSION)));
HXLINE( 376)			this->printDebug((HX_("Friday Night Funkin' version: ",4b,49,37,e6) + ::MainMenuState_obj::gameVer));
HXLINE( 377)			this->printDebug((HX_("Sten Engine version: ",76,eb,66,93) + ::MainMenuState_obj::StenEngineVer));
            		}
HXLINE( 388)		this->startTime = ::Sys_obj::time();
            	}
...
bool DebugLogWriter_obj::isActive(){
            	HX_STACKFRAME(&_hx_pos_161373f69ee8fd30_393_isActive)
HXDLIN( 393)		return this->active;
            	}
...
bool DebugLogWriter_obj::shouldLog(::String input){
            	HX_STACKFRAME(&_hx_pos_161373f69ee8fd30_412_shouldLog)
HXLINE( 413)		int levelIndex = ::DebugLogWriter_obj::LOG_LEVELS->indexOf(input,null());
HXLINE( 415)		if ((levelIndex == -1)) {
HXLINE( 416)			return false;
            		}
HXLINE( 417)		return (levelIndex <= this->logLevel);
            	}
...
void DebugLogWriter_obj::setLogLevel(::String input){
            	HX_STACKFRAME(&_hx_pos_161373f69ee8fd30_421_setLogLevel)
HXLINE( 422)		int levelIndex = ::DebugLogWriter_obj::LOG_LEVELS->indexOf(input,null());
HXLINE( 424)		if ((levelIndex == -1)) {
HXLINE( 425)			return;
            		}
HXLINE( 427)		this->logLevel = levelIndex;
HXLINE( 428)		::flixel::FlxG_obj::save->data->__SetField(HX_("debugLogLevel",d3,6b,21,7d),this->logLevel,::hx::paccDynamic);
            	}
...
void DebugLogWriter_obj::write(::cpp::VirtualArray input,::String __o_logLevel){
            		...
            		if (::hx::IsNull(__o_logLevel)) logLevel = HX_("STEN TRACE",0f,95,f7,04);
            	HX_STACKFRAME(&_hx_pos_161373f69ee8fd30_435_write)
HXLINE( 436)		Float ts;
HXDLIN( 436)		{
HXLINE( 436)			Float ts1 = ::Sys_obj::time();
HXDLIN( 436)			ts = (ts1 - this->startTime);
            		}
HXDLIN( 436)		::String ts2 = ::flixel::util::FlxStringUtil_obj::formatTime(ts,true);
HXLINE( 437)		::String msg = ((((HX_("",00,00,00,00) + ts2) + HX_(" [",3b,1c,00,00)) + ::StringTools_obj::rpad(logLevel,HX_(" ",20,00,00,00),5)) + HX_("] ",23,51,00,00));
HXDLIN( 437)		::String msg1 = (msg + input->join(HX_("",00,00,00,00)));
HXLINE( 440)		bool _hx_tmp;
HXDLIN( 440)		if (this->active) {
HXLINE( 440)			_hx_tmp = ::hx::IsNotNull( this->file );
            		}
            		else {
...
HXLINE( 444)				this->file->writeString(((HX_("",00,00,00,00) + msg1) + HX_("\n",0a,00,00,00)),null());
HXLINE( 445)				this->file->flush();
HXLINE( 446)				this->file->flush();
            			}
            		}
HXLINE( 452)		if (this->shouldLog(logLevel)) {
HXLINE( 454)			this->printDebug(msg1);
            		}
            	}
...
void DebugLogWriter_obj::printDebug(::String msg){
            	HX_STACKFRAME(&_hx_pos_161373f69ee8fd30_461_printDebug)
HXDLIN( 461)		::Sys_obj::println(msg);
            	}
